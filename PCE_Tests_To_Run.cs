...
{
    [TestFixture]
    [Property("BST Find And Remove Next Smallest: Normal Case", -2)]
    [Property("BST Find And Remove Next Smallest: One Step Left", -1)]
    [Property("BST Find And Remove Next Smallest: One Step Left With Subtree", -1)]
    [Property("BST Find And Remove Next Smallest: One Step Right", -1)]
    [Property("BST Find And Remove Next Smallest: One Step Right With Subtree", -1)]
    [Property("BST.Remove from Empty Tree", -1)]
    [Property("BST.Remove from tree with single node", -1)]
    [Property("BST.Remove from tree with two nodes", -1)]
    [Property("BST.Remove from three element tree (case 2)", -1)]
    [Property("BST.Remove (general)", -2)]
    [Property("QS_Partition", -1)]
    [Property("QS_QuickSort", -2)]
    [Property("QS_QuickSort_BiggerArrays", -1)]
    class CategoryPenalties
    {
        // This is intentionally an empty class.
        // It's purpose is to list the point penalties for failing tests.
        // The rule is: if any test in a given category fails, then
        // the corresponding point penalty is applied (once only once) to the 
        // overall grade
    }

    [TestFixture]
    [Property("PointBonus", +2)]        // you get a 2 point bonus...
    [Property("PointBonusMinimum", 6)]  // as long as you get 6 points (or more)
    class PointBonusInfo
    {
        // This is intentionally an empty class.
        // It's purpose is to list the point bonus (if any) once your raw score
        // reaches (or exceeds) the minimum threshold.
        // Bonus cannot go above the maximum score for the assignment
    }
    ...
    public class BST_FindAndRemoveNextSmaller
    {
        ...
        [Test]
        [Property("GradingCategory", "BST Find And Remove Next Smallest: Normal Case")]
        ...
        [Test]
        [Property("GradingCategory", "BST Find And Remove Next Smallest: One Step Left")]
        ...
        [Test]
        [Property("GradingCategory", "BST Find And Remove Next Smallest: One Step Left With Subtree")]
        ...
        [Test]
        [Property("GradingCategory", "BST Find And Remove Next Smallest: One Step Right")]
        ...
        [Test]
        [Property("GradingCategory", "BST Find And Remove Next Smallest: One Step Right With Subtree")]
    ...
    public class BST_Remove
    {
        ...
        [Test]
        [Property("GradingCategory", "BST.Remove from Empty Tree")]
        ...
        [Test]
        [Property("GradingCategory", "BST.Remove from tree with single node")]
        ...
        [Test]
        [Property("GradingCategory", "BST.Remove from tree with two nodes")]
        ...
        [Test]
        [Property("GradingCategory", "BST.Remove from three element tree (case 2)")]
        ...
        [Test]
        [Property("GradingCategory", "BST.Remove (general)")]
    ...
    public class Test_Partition : TestHelpers
    {
        ...
        [Test]
        [Property("GradingCategory", "QS_Partition")]
    ...
    public class Test_QuickSort : TestHelpers
    {
        ...
        [Test]
        [Property("GradingCategory", "QS_QuickSort")]
        ...
        {
            Console.WriteLine("Test: Sort an array of no elements");
            int[] numsStarting = { -1, 0, 7, 777 };
            int[] numsExpected = { -1, 0, 7, 777 };
            qsorter.QuickSort(numsStarting);
            Assert.That(ArraysTheSame(numsExpected, numsStarting) == true, "TEST FAILED: QuickSort did not sort the array correctly!");
        }
        ...
        [TestCase(10)]
        [TestCase(7)]
        [Property("GradingCategory", "QS_QuickSort_BiggerArrays")]
